...
;; TODO: set up for the new api.byu.edu usage

;; PERSONAL
(def consumer-key "q9vFW1SmSf5IDMUNJ7TxdwTZCTsa")
(def consumer-secret "3W1RyHVntmFxD7q6Pecdb63h4_oa")
(def access-token "")
(def my-url "https://humplus-funding.byu.edu")
...
(defn stage2-request [& [{:keys [client-id client-secret authorization-code redirect_uri]}]]
...
;; (def req-map  {:client-id "q9vFW1SmSf5IDMUNJ7TxdwTZCTsa",
;;                :client-secret "3W1RyHVntmFxD7q6Pecdb63h4_oa",
;;                :redirect_uri "https://humplus-funding.byu.edu",
;;                :authorization-code "6533ebe43ec5e69fc8a1cf156bcad3" ;; will need to be replaced})

(defn api-user-data
  "Already having an auth code, obtain and decrypt the user data from a token request"
  [post-map]
